(function($) {
    ...
    Alpaca.Fields.SubmittedByField = Alpaca.Fields.TextField.extend(
    /**
     ...
     */
    {
        ...
        getDescription: function() {
            return "Text Field for recipient's name or submission owner.";
        }

        /* end_builder_helpers */
    });

    Alpaca.registerFieldClass("submittedby", Alpaca.Fields.SubmittedByField);
